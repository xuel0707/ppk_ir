...
#undef T
	...
	const event_dequeue_t ssow_deq[3][3][3] = {
#define R(name, f2, f1, f0, flags)					\
...
#undef R
	...
	const event_dequeue_burst_t ssow_deq_burst[3][3][3] = {
#define R(name, f2, f1, f0, flags)					\
...
#undef R
	...
	if (edev->is_timeout_deq) {
		const event_dequeue_t ssow_deq_timeout[3][3][3] = {
#define R(name, f2, f1, f0, flags)					\
...
#undef R
		...
		const event_dequeue_burst_t ssow_deq_timeout_burst[3][3][3] = {
#define R(name, f2, f1, f0, flags)					\
