...
void backend_processor(void* bg)
{
    ...
    while (1)
    {
        //debug("\033[1;32m""ctrl_plane_backend.c: backend_processor()begins xmxmxmxmxmxmxmxmx\n""\033[0m");
        tv.tv_sec = 5;
        tv.tv_usec = 0;
        rfs = master;
        //debug("\033[1;32m""mmmmmmmmmmmmmmmmmmmmmmmmmmmm, the value of rv is %d\n""\033[0m", rv);
        rv = select(bgt->controller_sock+1, &rfs, 0, 0, &tv);
        //debug("\033[1;32m""nnnnnnnnnnnnnnnnnnnnnnnnnnnn, the value of rv is %d\n""\033[0m", rv);
        //debug("\033[1;32m""the value of shutdown is %u\n""\033[0m",bgt->shutdown);        
        ...
        if (FD_ISSET(bgt->controller_sock, &rfs))
        {
            ...
            //debug("\033[1;32m""ctrl_plane_backend.c: backend_processor()begins oooooooooooo\n""\033[0m");
            if ((rv=read_p4_msg(bgt->controller_sock, mem_cell->data, mem_cell->length)) > 0)
            {
                //debug("\033[1;32m""ctrl_plane_backend.c: backend_processor()begins rrrrrrrrrr\n""\033[0m");
                fifo_add_msg( &(bgt->input_queue), (void*)mem_cell );
                //debug("\033[1;32m""ctrl_plane_backend.c: backend_processor()begins ssssssssss\n""\033[0m");
...
void input_processor(void *bg)
{
    ...
    while ( 1 )
    {
        //printf("\033[1;32m""ctrl_plane_backend.c: In input_processor, ready to recvfrom_controller\n""\033[0m");
        fifo_wait( &(bgt->input_queue) );
        mem_cell = fifo_remove_msg(&(bgt->input_queue));
        // fp6 = fopen("/home/zhaoxin/log/fenpian.txt","a");
        //  if(fp6){
        //  fprintf(fp6,"111111111111111111111");
        //          fprintf(fp6,"\n");
        //          fclose(fp6);
        //      }
        if (bgt->shutdown==1) break;
        // fp6 = fopen("/home/zhaoxin/log/fenpian.txt","a");
        // if(fp6){
        //  fprintf(fp6,"222222222222222222222");
        //          fprintf(fp6,"\n");
        //          fclose(fp6);
        //      }
        ...
        // fp6 = fopen("/home/zhaoxin/log/fenpian.txt","a");
        // if(fp6){
        //  fprintf(fp6,"33333333333333333333333mem_cell->length=%d",mem_cell->length);
        //          fprintf(fp6,"\n");
        //          fclose(fp6);
        //      }
//        printf("\033[1;32m""ctrl_plane_backend.c: In input_processor, ready to recvfrom_controller\n""\033[0m");
...
{
//    printf("ctrl_plane_backend.c: ctrl_plane_backend() begins \n");
    backend_t *bg;
    mem_cell_t *tmp;
    int i;
...
{
    //debug("\033[1;32m""ctrl_plane_backend.c: Launch-backend()begins xmxmxmxmxmxmxmxmx\n""\033[0m");
    backend_t *bgt = (backend_t*) bg;
    ...
    //debug("\033[1;32m""22ctrl_plane_backend.c: Launch-backend()begins xmxmxmxmxmxmxmxmx\n""\033[0m");
    ...
    //debug("\033[1;32m""33ctrl_plane_backend.c: Launch-backend()begins xmxmxmxmxmxmxmxmx\n""\033[0m");
