...
if [[ $os_bit =~ "x86_64" ]];then
   ...
   export RTE_SDK=/home/aa/ppk_sw/ppk/dpdk-stable-19.11/
   export RTE_TARGET=x86_64-native-linuxapp-gcc
   export P4C=/home/aa/ppk_sw/ppk/p4c	
   export PPK=ppk
elif [[ $os_bit =~ "aarch64" ]] && [[ $USER =~ "pinet" ]];then
   export DPDK_VSN=Marvell-v8
   export RTE_SDK=/home/pinet/ppk_sw/ppk/dpdk-stable-19.11/
   export RTE_TARGET=arm64-armv8a-linuxapp-gcc
   export P4C=/home/pinet/ppk_sw/ppk/p4c
   export PPK=ppk
