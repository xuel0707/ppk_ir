 ...
 *
 *  This function assumes that the TXGBE_GSSR_SW_MNG_SM semaphore is held
 *  by the caller.
 **/
static s32
...
//	fwsts = rd32(hw, TXGBE_FWSTS);
//	wr32(hw, TXGBE_FWSTS, fwsts | TXGBE_FWSTS_FWRI);

	/* Check that the host interface is enabled. */
//	hicr = rd32(hw, TXGBE_HICR);
//	if (!(hicr & TXGBE_HICR_EN)) {
//		DEBUGOUT("TXGBE_HOST_EN bit disabled.\n");
//		return TXGBE_ERR_HOST_INTERFACE_COMMAND;
//	}
