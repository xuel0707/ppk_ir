...
bind_devices_to_igb_uio()
{
	if [ -d /sys/module/igb_uio ]; then
		...
		# read PCI_PATH
		PCI_PATH="01:00.0 01:00.1 01:00.2 01:00.3 02:00.0 05:00.0 06:00.0 07:00.0 08:00.0 09:00.0 0a:00.0 0b:00.0 0c:00.0"
