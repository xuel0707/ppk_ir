...
export RTE_SDK=$PWD
export _EQT_PATH_EXTGMSSL=$RTE_SDK/eqt/gmssl
echo "------------------------------------------------------------------------------"
echo " RTE_SDK exported as $RTE_SDK"
echo " _EQT_PATH_EXTGMSSL exported as $_EQT_PATH_EXTGMSSL"
echo "------------------------------------------------------------------------------"
...
setup_target()
{
	...
	echo "------------------------------------------------------------------------------"
	cp  -rf $_EQT_PATH_EXTGMSSL/include/* $RTE_SDK/$RTE_TARGET/include/
	cp $RTE_SDK/app/rsp_benchmark/crypto_api.h $RTE_SDK/$RTE_TARGET/include/
	cp $_EQT_PATH_EXTGMSSL/lib/lib*.a $RTE_SDK/$RTE_TARGET/lib/
	cp $RTE_SDK/app/rsp_benchmark/libcrypto_api.a $RTE_SDK/$RTE_TARGET/lib
}
