...
#define RTE_LIBRTE_PMD_QAT_SYM 1
#undef RTE_LIBRTE_PMD_QAT_ASYM
#define RTE_LIBRTE_PMD_QAT_ASYM 1
...
#undef RTE_LIBRTE_PMD_RSP
#define RTE_LIBRTE_PMD_RSP 1
#undef RTE_LIBRTE_PMD_RSP_SYM
#define RTE_LIBRTE_PMD_RSP_SYM 1
#undef RTE_LIBRTE_PMD_RSP_ASYM
#define RTE_LIBRTE_PMD_RSP_ASYM 1
#undef RTE_PMD_RSP_MAX_PCI_DEVICES
#define RTE_PMD_RSP_MAX_PCI_DEVICES 48
