...
#define   TXGBE_AUTOC_AUTONEG           MS64(62, 0x1)
#define   TXGBE_AUTOC_VALID             MS64(63, 0x1)
...
#define   TXGBE_LEDCTL_OD_SHIFT         16
...
#define   TXGBE_ITR_IVAL_MASK           MS(2, 0x3FE) /* 1ns/10G, 10ns/REST */
#define   TXGBE_ITR_IVAL(v)             LS(v, 2, 0x3FE) /* 1ns/10G, 10ns/REST */
