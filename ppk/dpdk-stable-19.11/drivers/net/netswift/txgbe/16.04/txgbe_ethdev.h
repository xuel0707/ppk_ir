 ...
 * FreeBSD driver.
 */
//#define TXGBE_EXTENDED_VLAN	  (uint32_t)(1 << 26) /* EXTENDED VLAN ENABLE */
...
#define TXGBE_ETH_OVERHEAD (ETHER_HDR_LEN + ETHER_CRC_LEN)
...
//#define TXGBE_VF_IRQ_ENABLE_MASK        3          /* vf irq enable mask */
//#define TXGBE_VF_MAXMSIVECTOR           1
...
#define TXGBE_LINK_SPEED_X550_AUTONEG	(TXGBE_LINK_SPEED_100M_FULL | \
					 TXGBE_LINK_SPEED_1GB_FULL | \
					 TXGBE_LINK_SPEED_2_5GB_FULL | \
					 TXGBE_LINK_SPEED_5GB_FULL | \
