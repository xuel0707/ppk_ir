...
#define NGBE_VF_GET_LINK_STATUS	0x20
...
s32 ngbe_read_mbx(struct ngbe_hw *, u32 *, u16, u16);
s32 ngbe_write_mbx(struct ngbe_hw *, u32 *, u16, u16);
s32 ngbe_read_posted_mbx(struct ngbe_hw *, u32 *, u16, u16);
s32 ngbe_write_posted_mbx(struct ngbe_hw *, u32 *, u16, u16);
s32 ngbe_check_for_msg(struct ngbe_hw *, u16);
s32 ngbe_check_for_ack(struct ngbe_hw *, u16);
s32 ngbe_check_for_rst(struct ngbe_hw *, u16);
void ngbe_init_mbx_params_vf(struct ngbe_hw *);
void ngbe_init_mbx_params_pf(struct ngbe_hw *);

s32 ngbe_read_mbx_pf(struct ngbe_hw *, u32 *, u16, u16);
s32 ngbe_write_mbx_pf(struct ngbe_hw *, u32 *, u16, u16);
s32 ngbe_check_for_msg_pf(struct ngbe_hw *, u16);
s32 ngbe_check_for_ack_pf(struct ngbe_hw *, u16);
s32 ngbe_check_for_rst_pf(struct ngbe_hw *, u16);

s32 ngbe_read_mbx_vf(struct ngbe_hw *, u32 *, u16, u16);
s32 ngbe_write_mbx_vf(struct ngbe_hw *, u32 *, u16, u16);
s32 ngbe_check_for_msg_vf(struct ngbe_hw *, u16);
s32 ngbe_check_for_ack_vf(struct ngbe_hw *, u16);
s32 ngbe_check_for_rst_vf(struct ngbe_hw *, u16);
