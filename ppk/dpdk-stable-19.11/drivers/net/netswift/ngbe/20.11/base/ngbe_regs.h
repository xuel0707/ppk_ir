...
#define   NGBE_AUTOC_LMS_10Gs          LS64(3, 13, 0x7)
...
//#define   NGBE_PORTCTL_DCB           MS(10, 0x1)
...
//#define   NGBE_PORTSTAT_UP		MS(0, 0x1)
...
//#define   NGBE_RACTL_RSSMKEY		MS(0, 0x1)
...
//#define   NGBE_PSRCTL_RSCPUSH        MS(15, 0x1)
//#define   NGBE_PSRCTL_RSCDIA	       MS(16, 0x1)
//#define   NGBE_PSRCTL_RSCACK	       MS(17, 0x1)
...
//#define   NGBE_ETFLT_FCOE              MS(27, 0x1)
...
//#define NGBE_MIRRVLANH(i)	       0x015B14 + (i) * 8
#define NGBE_MIRRPOOLL(i)	       0x015B30 + (i) * 8
//#define NGBE_MIRRPOOLH(i)	       0x015B34 + (i) * 8
 ...
 ******************************************************************************/
/* Ring Counter */
#define NGBE_QPRXPKT(rp)		0x001014 + 0x40 * (rp) /*0-7*/
...
//#define   NGBE_ICRMISC_LNKDN	MS(8, 0x1) /* eth link down */
...
//#define   NGBE_ICRMISC_FDIR	MS(15, 0x1) /* FDir Exception */
//#define   NGBE_ICRMISC_I2C	MS(16, 0x1) /* I2C interrupt */
#define   NGBE_ICRMISC_ERRMAC	MS(17, 0x1) /* err reported by MAC */
#define   NGBE_ICRMISC_PHY	MS(18, 0x1) /* interrupt reported by eth phy */
//#define   NGBE_ICRMISC_ANDONE	MS(19, 0x1) /* link auto-nego done */
...
#if 0
#define   NGBE_VFPLCFG_RSSMASK		MS(16, 0xFF)
#define   NGBE_VFPLCFG_RSSIPV4TCP	MS(16, 0x1)
#define   NGBE_VFPLCFG_RSSIPV4		MS(17, 0x1)
#define   NGBE_VFPLCFG_RSSIPV6		MS(20, 0x1)
#define   NGBE_VFPLCFG_RSSIPV6TCP	MS(21, 0x1)
#define   NGBE_VFPLCFG_RSSIPV4UDP	MS(22, 0x1)
#define   NGBE_VFPLCFG_RSSIPV6UDP	MS(23, 0x1)
#define   NGBE_VFPLCFG_RSSENA		MS(24, 0x1)
#define   NGBE_VFPLCFG_RSSHASH(v)	LS(v, 29, 0x7)
#endif
//#define NGBE_VFRSSKEY(i)		0x000080 + (i) * 4 /*0-9*/
//#define NGBE_VFRSSTBL(i)		0x0000C0 + (i) * 4 /*0-15*/
...
//#define   NGBE_VFICR_DONE2		MS(2, 0x1)
...
//#define   NGBE_RXCFG_RSCMAX_MASK	MS(23, 0x3)
//#define     NGBE_RXCFG_RSCMAX_1	LS(0, 23, 0x3)
//#define     NGBE_RXCFG_RSCMAX_4	LS(1, 23, 0x3)
//#define     NGBE_RXCFG_RSCMAX_8	LS(2, 23, 0x3)
//#define     NGBE_RXCFG_RSCMAX_16	LS(3, 23, 0x3)
//#define   NGBE_RXCFG_STALL		MS(25, 0x1)
#define   NGBE_RXCFG_SPLIT		MS(26, 0x1)
//#define   NGBE_RXCFG_RSCMODE		MS(27, 0x1)
#define   NGBE_RXCFG_CNTAG		MS(28, 0x1)
//#define   NGBE_RXCFG_RSCENA		MS(29, 0x1)
...
//#define NGBE_PRBPTN                    0x010224
#define NGBE_PRBCNT                    0x010228
//#define NGBE_PRBMSK                    0x01022C
...
#if 1 /* legacy intel definitions <begin> */
...
#endif /* legacy intel definitions <end> */

#define NGBE_REG_RSSTBL   NGBE_RSSTBL(0)
#define NGBE_REG_RSSKEY   NGBE_RSSKEY(0)
#if 0
static inline u32
ngbe_map_reg(struct ngbe_hw *hw, u32 reg)
{
	switch (reg) {
	case NGBE_REG_RSSTBL:
		if (hw->mac.type == ngbe_mac_sp_vf)
			reg = NGBE_VFRSSTBL(0);
		break;
	case NGBE_REG_RSSKEY:
		if (hw->mac.type == ngbe_mac_sp_vf)
			reg = NGBE_VFRSSKEY(0);
		break;
	default:
