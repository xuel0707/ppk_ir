...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/rpc/status.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Status& Status::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2frpc_2fstatus_2eproto::scc_info_Status.base);
