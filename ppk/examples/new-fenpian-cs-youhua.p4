...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_component1") state parse_component1 {
        ...
        packet.extract(hdr.component1, (bit<32>)(((bit<32>)meta.name_metadata.tmp + 32w2) * 8 - 16));
    ...
    @name(".parse_component2") state parse_component2 {
        meta.name_metadata.tmp = (packet.lookahead<bit<16>>())[7:0];
        //tmp_hdr = (packet.lookahead<bit<16>>())[15:8];
        packet.extract(hdr.component2, (bit<32>)(((bit<32>)meta.name_metadata.tmp + 32w2) * 8 - 16));
        meta.name_metadata.namesize = meta.name_metadata.namesize - meta.name_metadata.tmp - 8w2;
        transition select(meta.name_metadata.namesize) {
            8w0: parse_default;
    ...
    @name(".parse_component3") state parse_component3 {
        meta.name_metadata.tmp = (packet.lookahead<bit<16>>())[7:0];
        //tmp_hdr = (packet.lookahead<bit<16>>())[15:8];
        packet.extract(hdr.component3, (bit<32>)(((bit<32>)meta.name_metadata.tmp + 32w2) * 8 - 16));
         meta.name_metadata.namesize = meta.name_metadata.namesize - meta.name_metadata.tmp - 8w2;
        transition select(meta.name_metadata.namesize) {
            8w0: parse_default;
    ...
    @name(".parse_component4") state parse_component4 {
        meta.name_metadata.tmp = (packet.lookahead<bit<16>>())[7:0];
        //tmp_hdr = (packet.lookahead<bit<16>>())[15:8];
        packet.extract(hdr.component4, (bit<32>)(((bit<32>)meta.name_metadata.tmp + 32w2) * 8 - 16));
         meta.name_metadata.namesize = meta.name_metadata.namesize - meta.name_metadata.tmp - 8w2;
        transition select(meta.name_metadata.namesize) {
            8w0: parse_default;
    ...
    @name(".parse_component5") state parse_component5 {
        meta.name_metadata.tmp = (packet.lookahead<bit<16>>())[7:0];
        //tmp_hdr = (packet.lookahead<bit<16>>())[15:8];
        packet.extract(hdr.component5, (bit<32>)(((bit<32>)meta.name_metadata.tmp + 32w2) * 8 - 16));
         meta.name_metadata.namesize = meta.name_metadata.namesize - meta.name_metadata.tmp - 8w2;
        transition select(meta.name_metadata.namesize) {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action computeNameHashes() {
        hash(meta.comp_metadata.c1, HashAlgorithm.crc16, (bit<16>)0, { hdr.component1.tlv_value }, (bit<32>)65536);
        hash(meta.comp_metadata.c2, HashAlgorithm.crc16, (bit<16>)0, { hdr.component1.tlv_value, hdr.component2.tlv_value }, (bit<32>)65536);
        hash(meta.comp_metadata.c3, HashAlgorithm.crc16, (bit<16>)0, { hdr.component1.tlv_value, hdr.component2.tlv_value, hdr.component3.tlv_value }, (bit<32>)65536);
        hash(meta.comp_metadata.c4, HashAlgorithm.crc16, (bit<16>)0, { hdr.component1.tlv_value, hdr.component2.tlv_value, hdr.component3.tlv_value, hdr.component4.tlv_value }, (bit<32>)65536);
    } 
    action computeStoreTablesIndex() {
        hash(meta.name_metadata.name_hash, HashAlgorithm.crc16, (bit<16>)0, { hdr.component1.tlv_value, hdr.component2.tlv_value, hdr.component3.tlv_value, hdr.component4.tlv_value, hdr.component5.tlv_value }, (bit<32>)65536);
        computeNameHashes();
    }
    action readPit() {
    ...
    table count_table {
        ...
        key = {
            hdr.component1.isValid(): exact;
            hdr.component2.isValid(): exact;
            hdr.component3.isValid(): exact;
            hdr.component4.isValid(): exact;
            hdr.component5.isValid(): exact;
        }
        size = 5;
    }
    table fib_table {
