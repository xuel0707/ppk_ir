...
control MyIngress(inout headers hdr,
    ...
    @name(".drop_stats")counter(3, CounterType.packets_and_bytes) drop_stats;
    @name(".hit_stats")counter(3, CounterType.packets) hit_stats;
    @name(".send_to_cpu_stats") direct_counter(CounterType.packets_and_bytes) send_to_cpu_stats;
    action send_to_cpu() {
        //send_to_cpu_stats.count();
    ...
    table dest_guid_exact {
        ...
        size = 1024;
        @name(".MyIngress_guid_exact_stats")counters = direct_counter(CounterType.packets_and_bytes);
    }
