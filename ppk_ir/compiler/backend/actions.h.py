...
#[ action_set_clone_multicast_group_id,
#[ action_,
#} };
...
#[  typedef struct action_set_bitmcast_params_s {
#[  FIELD(bit_mcast, 32); // compiler/backend/actions.h.py:52
#[  FIELD(DUMMY_FIELD, 0);
#[  } action_set_bitmcast_params_t;
#[  typedef struct action_set_clone_egress_port_params_s {
#[  FIELD(egress_port, 9);    
#[  FIELD(DUMMY_FIELD, 0);
#[  } action_set_clone_egress_port_params_t;
#[  typedef struct action_set_clone_multicast_group_id_params_s {
#[  FIELD(multicast_group_id, 16);
#[  FIELD(DUMMY_FIELD, 0);
#[  } action_set_clone_multicast_group_id_params_t;
...
for table in hlir16.tables:
    ...
    #} };
    #[
#[ struct multicast_group_table_action { 
#[     int action_id; 
#[     union {
#[         action_set_bitmcast_params_t set_bitmcast_params; 
#[     }; 
#[ }; 
#[ struct clone_session_table_action { 
#[     int action_id; 
#[     union {
#[         action_set_clone_egress_port_params_t set_clone_egress_port_params; 
#[         action_set_clone_multicast_group_id_params_t set_clone_multicast_group_id_params; 
#[     }; 
#[ }; 
...
#[ void action_code_$aname(packet_descriptor_t *pd, packet_descriptor_t *clone_pd, lookup_table_t **tables, action_${mname}_params_t);
#[ void action_code_set_bitmcast(packet_descriptor_t *pd,  packet_descriptor_t *clone_pd, lookup_table_t **tables, action_set_bitmcast_params_t);
#[ void action_code_set_clone_egress_port(packet_descriptor_t *pd,  packet_descriptor_t *clone_pd, lookup_table_t **tables, action_set_clone_egress_port_params_t);
