...
/*N*/#define TXGBE_SFF_SFF_8472_UNSUP	0x00
...
/* (dev_type = all) */
/*N*/#define TXGBE_MD_GLOBAL_INT_CHIP_STD_MASK	0xFF00 /* int std mask */
/*N*/#define TXGBE_MD_GLOBAL_CHIP_STD_INT_FLAG	0xFC00 /* chip std int flag */
/*N*/#define TXGBE_MD_GLOBAL_INT_CHIP_VEN_MASK	0xFF01 /* int chip-wide mask */
/*N*/#define TXGBE_MD_GLOBAL_INT_CHIP_VEN_FLAG	0xFC01 /* int chip-wide mask */
/*N*/#define TXGBE_MD_GLOBAL_ALARM_1		0xCC00 /* Global alarm 1 */
/*N*/#define TXGBE_MD_GLOBAL_ALM_1_DEV_FAULT	0x0010 /* device fault */
/*N*/#define TXGBE_MD_GLOBAL_ALM_1_HI_TMP_FAIL	0x4000 /* high temp failure */
/*N*/#define TXGBE_MD_GLOBAL_FAULT_MSG	0xC850 /* Global Fault Message */
/*N*/#define TXGBE_MD_GLOBAL_FAULT_MSG_HI_TMP	0x8007 /* high temp failure */
/*N*/#define TXGBE_MD_GLOBAL_INT_MASK		0xD400 /* Global int mask */
/*N*/#define TXGBE_MD_GLOBAL_AN_VEN_ALM_INT_EN	0x1000 /* autoneg vendor alarm int enable */
/*N*/#define TXGBE_MD_GLOBAL_ALARM_1_INT		0x4 /* int in Global alarm 1 */
/*N*/#define TXGBE_MD_GLOBAL_VEN_ALM_INT_EN	0x1 /* vendor alarm int enable */
/*N*/#define TXGBE_MD_GLOBAL_STD_ALM2_INT		0x200 /* vendor alarm2 int mask */
/*N*/#define TXGBE_MD_GLOBAL_INT_HI_TEMP_EN	0x4000 /* int high temp enable */
/*N*/#define TXGBE_MD_GLOBAL_INT_DEV_FAULT_EN 0x0010 /* int dev fault enable */

/* (dev_type = 0) */
#define TXGBE_MD_DEV_ZERO		0x0
/*N*/#define TXGBE_CS4227			0xBE	/* CS4227 address */
/*N*/#define   TXGBE_CS4227_GLOBAL_ID_LSB	0
/*N*/#define   TXGBE_CS4227_GLOBAL_ID_MSB	1
/*N*/#define   TXGBE_CS4227_SCRATCH		2
/*N*/#define   TXGBE_CS4227_GLOBAL_ID_VALUE	0x03E5
/*N*/#define   TXGBE_CS4227_EFUSE_PDF_SKU	0x19F
/*N*/#define   TXGBE_CS4223_SKU_ID		0x0010	/* Quad port */
/*N*/#define   TXGBE_CS4227_SKU_ID		0x0014	/* Dual port */
/*N*/#define   TXGBE_CS4227_RESET_PENDING	0x1357
/*N*/#define   TXGBE_CS4227_RESET_COMPLETE	0x5AA5
/*N*/#define   TXGBE_CS4227_RETRIES		15
/*N*/#define   TXGBE_CS4227_EFUSE_STATUS	0x0181
/*N*/#define   TXGBE_CS4227_LINE_SPARE22_MSB	0x12AD	/* Reg to program speed */
/*N*/#define   TXGBE_CS4227_LINE_SPARE24_LSB	0x12B0	/* Reg to program EDC */
/*N*/#define   TXGBE_CS4227_HOST_SPARE22_MSB	0x1AAD	/* Reg to program speed */
/*N*/#define   TXGBE_CS4227_HOST_SPARE24_LSB	0x1AB0	/* Reg to program EDC */
/*N*/#define   TXGBE_CS4227_EEPROM_STATUS	0x5001
/*N*/#define   TXGBE_CS4227_EEPROM_LOAD_OK	0x0001
/*N*/#define   TXGBE_CS4227_SPEED_1G		0x8000
/*N*/#define   TXGBE_CS4227_SPEED_10G		0
/*N*/#define   TXGBE_CS4227_EDC_MODE_CX1	0x0002
/*N*/#define   TXGBE_CS4227_EDC_MODE_SR	0x0004
/*N*/#define   TXGBE_CS4227_EDC_MODE_DIAG	0x0008
/*N*/#define   TXGBE_CS4227_RESET_HOLD		500	/* microseconds */
/*N*/#define   TXGBE_CS4227_RESET_DELAY	450	/* milliseconds */
/*N*/#define   TXGBE_CS4227_CHECK_DELAY	30	/* milliseconds */
/*N*/#define   TXGBE_PE			0xE0	/* Port expander address */
/*N*/#define   TXGBE_PE_OUTPUT			1	/* Output register offset */
/*N*/#define   TXGBE_PE_CONFIG			3	/* Config register offset */
/*N*/#define   TXGBE_PE_BIT1			(1 << 1)
...
/*N*/#define TXGBE_MD_PHY_SPEED_10G	0x0001 /* 10G capable */
/*N*/#define TXGBE_MD_PHY_SPEED_1G		0x0010 /* 1G capable */
/*N*/#define TXGBE_MD_PHY_SPEED_100M	0x0020 /* 100M capable */
#define TXGBE_MD_PHY_EXT_ABILITY	0xB /* Ext Ability Reg */
/*N*/#define TXGBE_MD_PHY_10GBASET_ABILITY		0x0004 /* 10GBaseT capable */
/*N*/#define TXGBE_MD_PHY_1000BASET_ABILITY	0x0020 /* 1000BaseT capable */
/*N*/#define TXGBE_MD_PHY_100BASETX_ABILITY	0x0080 /* 100BaseTX capable */
/*N*/#define TXGBE_MD_PHY_SET_LOW_POWER_MODE	0x0800 /* Set low power mode */
...
/*N*/#define TXGBE_MD_TX_VENDOR_ALARMS_3_RST_MASK	0x3 /* PHY Reset Complete Mask */
/*N*/#define TXGBE_MD_GLOBAL_RES_PR_10 0xC479 /* Global Resv Provisioning 10 Reg */
/*N*/#define TXGBE_MD_POWER_UP_STALL		0x8000 /* Power Up Stall */
/*N*/#define TXGBE_MD_PMA_PMD_CONTROL_ADDR	0x0000 /* PMA/PMD Control Reg */
...
/*N*/#define TXGBE_TN_LASI_STATUS_REG	0x9005
/*N*/#define TXGBE_TN_LASI_STATUS_TEMP_ALARM	0x0008
...
/*N*/#define TXGBE_MD_PHY_XS_CONTROL	0x0 /* PHY_XS Control Reg */
/*N*/#define TXGBE_MD_PHY_XS_RESET		0x8000 /* PHY_XS Reset */

/* (dev_type = 7) */
#define TXGBE_MD_DEV_AUTO_NEG		0x7

/*N*/#define TXGBE_MD_AUTO_NEG_CONTROL	0x0 /* AUTO_NEG Control Reg */
/*N*/#define TXGBE_MD_AUTO_NEG_STATUS	0x1 /* AUTO_NEG Status Reg */
/*N*/#define TXGBE_MD_AUTO_NEG_VENDOR_STAT	0xC800 /* AUTO_NEG Vendor Status Reg */
/*N*/#define TXGBE_MD_AUTO_NEG_VENDOR_TX_ALARM 0xCC00 /* AUTO_NEG Vendor TX Reg */
/*N*/#define TXGBE_MD_AUTO_NEG_VENDOR_TX_ALARM2 0xCC01 /* AUTO_NEG Vendor Tx Reg */
/*N*/#define TXGBE_MD_AUTO_NEG_VEN_LSC	0x1 /* AUTO_NEG Vendor Tx LSC */
...
/*N*/#define TXGBE_MD_AUTO_NEG_LP		0x13 /* AUTO_NEG LP Status Reg */
/*N*/#define TXGBE_MD_AUTO_NEG_EEE_ADVT	0x3C /* AUTO_NEG EEE Advt Reg */
...
/*N*/#define TXGBE_MD_PMA_TX_VEN_LASI_INT_MASK 0xD401 /* PHY TX Vendor LASI */
/*N*/#define TXGBE_MD_PMA_TX_VEN_LASI_INT_EN   0x1 /* PHY TX Vendor LASI enable */
/*N*/#define TXGBE_MD_PMD_STD_TX_DISABLE_CNTR 0x9 /* Standard Transmit Dis Reg */
/*N*/#define TXGBE_MD_PMD_GLOBAL_TX_DISABLE 0x0001 /* PMD Global Transmit Dis */
...
/*N*/#define TXGBE_MD_VENDOR_SPECIFIC_1_CONTROL		0x0 /* VS1 Ctrl Reg */
/*N*/#define TXGBE_MD_VENDOR_SPECIFIC_1_STATUS		0x1 /* VS1 Status Reg */
/*N*/#define TXGBE_MD_VENDOR_SPECIFIC_1_LINK_STATUS	0x0008 /* 1 = Link Up */
/*N*/#define TXGBE_MD_VENDOR_SPECIFIC_1_SPEED_STATUS	0x0010 /* 0-10G, 1-1G */
/*N*/#define TXGBE_MD_VENDOR_SPECIFIC_1_10G_SPEED		0x0018
/*N*/#define TXGBE_MD_VENDOR_SPECIFIC_1_1G_SPEED		0x0010
...
s32 txgbe_handle_bp_flow(u32 link_mode, struct txgbe_hw *hw);
void txgbe_get_bp_ability(struct txgbe_backplane_ability *ability,
		u32 link_partner, struct txgbe_hw *hw);
s32 txgbe_check_bp_ability(struct txgbe_backplane_ability *local_ability,
	struct txgbe_backplane_ability *lp_ability, struct txgbe_hw *hw);
s32 txgbe_enable_kr_training(struct txgbe_hw *hw);
s32 txgbe_disable_kr_training(struct txgbe_hw *hw, s32 post, s32 mode);
s32 txgbe_check_kr_training(struct txgbe_hw *hw);
void txgbe_read_phy_lane_tx_eq(u16 lane, struct txgbe_hw *hw,
	s32 post, s32 mode);
