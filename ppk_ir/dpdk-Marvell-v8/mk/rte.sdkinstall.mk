...
install-sdk:
	...
	$(Q)cp $(CP_FLAGS) $(S_DRIVERS)/common/octeontx2/hw $(DESTDIR)$(includedir)
	$(Q)cp $(CP_FLAGS) $(S_DRIVERS)/mempool/octeontx2/*.h $(DESTDIR)$(includedir)
	$(Q)cp $(CP_FLAGS) $(S_DRIVERS)/common/octeontx2/*.h $(DESTDIR)$(includedir)
	$(Q)cp $(CP_FLAGS) $(S_DRIVERS)/net/octeontx2/*.h   $(DESTDIR)$(includedir)
	$(Q)cp $(CP_FLAGS) $(S_DRIVERS)/event/octeontx2/*.h  $(DESTDIR)$(includedir)
	$(Q)cp $(CP_FLAGS) $(S_DRIVERS)/crypto/octeontx2/*.h  $(DESTDIR)$(includedir) 
