...
#IFLAGS="-I. -I${GRPCDIR}/lib/h/ -I${GRPCDIR}/third_party/protobuf-c -I${GRPCDIR}/third_party/grpc/include -I./grpc-c-out/ -I./server/ -I../PI/proto/server -I${PPKDIR}/src/hardware_dep/shared/ctrl_plane"
IFLAGS="-I. -I./grpc-cpp-out/ -I./cpp-out/ -I./server/ -I./${PPKDIR}/ppk/shared/ctrl_plane -I./../PI/proto/server"
...
echo "Compiling table.c"
g++ ${DEBUG} ${IFLAGS} -std=c++11 -fpermissive `pkg-config --cflags protobuf grpc` -c -o obj/table.o utils/table.c
...
g++ ${DEBUG} ${IFLAGS} -std=c++11 -fpermissive `pkg-config --cflags protobuf grpc` -c -o obj/cJSON.o server/cJSON.c

echo "Compiling device_mgr_bak.c"
#gcc ${DEBUG} ${IFLAGS} -c -o obj/device_mgr.o server/device_mgr.c
# g++ ${DEBUG} ${IFLAGS} -std=c++11 -fpermissive `pkg-config --cflags protobuf grpc` -c -o obj/device_mgr_bak.o server/device_mgr_bak.c
...
echo "Compiling async_client_out.cc"
g++ ${DEBUG} ${IFLAGS} -std=c++11 `pkg-config --cflags protobuf grpc` -c -o obj/async_client_out.o server/async_client_out.cc

echo "Compiling async_client_in.cc"
g++ ${DEBUG} ${IFLAGS} -std=c++11 `pkg-config --cflags protobuf grpc` -c -o obj/async_client_in.o server/async_client_in.cc
...
echo "g++ ${DEBUG} ${IFLAGS} -o pi_server ${OBJECTS} obj/map.o obj/table.o obj/uint128.o obj/device_mgr.o obj/pi_server.o test_server.o -L/usr/local/lib `pkg-config --libs protobuf grpc++ grpc` -pthread -Wl,--no-as-needed -lgrpc++_reflection -Wl,--as-needed -ldl"
g++ ${DEBUG} ${IFLAGS} -o pi_server ${OBJECTS} obj/map.o obj/table.o obj/uint128.o  obj/pi_server.o obj/device_mgr.o obj/cJSON.o  test_server.o -L/usr/local/lib `pkg-config --libs protobuf grpc++ grpc` -pthread -Wl,--no-as-needed -lgrpc++_reflection -Wl,--as-needed -ldl
g++ ${DEBUG} ${IFLAGS} -o async_client_out ${OBJECTS} obj/map.o obj/table.o obj/uint128.o obj/device_mgr.o obj/cJSON.o obj/pi_server.o obj/async_client_out.o -L/usr/local/lib `pkg-config --libs protobuf grpc++ grpc` -pthread -Wl,--no-as-needed -lgrpc++_reflection -Wl,--as-needed -ldl
g++ ${DEBUG} ${IFLAGS} -o async_client_in ${OBJECTS} obj/map.o obj/table.o obj/uint128.o obj/device_mgr.o obj/cJSON.o obj/pi_server.o obj/async_client_in.o  -L/usr/local/lib `pkg-config --libs protobuf grpc++ grpc` -pthread -Wl,--no-as-needed -lgrpc++_reflection -Wl,--as-needed -ldl
...
cp utils/table.h include/utils/
